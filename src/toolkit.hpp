...
{
    int s1 = (l1_end.x - l1_start.x)*(l2_start.y-l1_start.y)-(l1_end.y - l1_start.y)*(l2_start.x-l1_start.x) > 0 ? 1 : -1;
    int s2 = (l1_end.x - l1_start.x)*(l2_end.y-l1_start.y)-(l1_end.y - l1_start.y)*(l2_end.x-l1_start.x) > 0 ? 1 : -1;
    int s3 = (l2_end.x - l2_start.x)*(l1_start.y-l2_start.y)-(l2_end.y - l2_start.y)*(l1_start.x-l2_start.x) > 0 ? 1 : -1;
    int s4 = (l2_end.x - l2_start.x)*(l1_end.y-l2_start.y)-(l2_end.y - l2_start.y)*(l1_end.x-l2_start.x) > 0 ? 1 : -1;
